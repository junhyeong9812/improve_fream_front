import './../css/recommendWrap.css';
import React, { useEffect, useState } from 'react';
import Product from './product';
import { productInfo } from '../types/homeTypes';
import { fetchRecommendData } from '../services/homeRecommendService';
import { recommendData } from '../data/dummyData';

const RecommendWrap: React.FC = () => {
